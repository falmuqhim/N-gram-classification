...
public class DSForm extends javax.swing.JFrame {
        ...
        if (evt.getSource() == sequenceBTN || evt.getSource() == sequenceBTN1) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                ...
                if (evt.getSource() == sequenceBTN1) {
                    sequenceFile1 = fileChooser.getSelectedFile();
        ...
        if (evt.getSource() == outputBTN || evt.getSource() == outputBTN1) {
            ...
            if (returnVal == JFileChooser.APPROVE_OPTION) {
                if (evt.getSource() == outputBTN) {
                    ...
                    outputDirectoryTF.setText(directory.getAbsolutePath());
                }
                if (evt.getSource() == outputBTN1) {
                    directory1 = directoryChooser.getSelectedFile();
                    outputDirectoryTF1.setText(directory1.getAbsolutePath());
                }
            } else {
                System.out.println("closed by user");
            }
    ...
    private void runBTNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runBTNActionPerformed
        // TODO add your handling code here:
        if (sequenceFile == null || directory == null) {
        ...
        int numberOfDuplicate = ds.removeDuplicate(sequenceFile.getPath(), directory.getPath() + "/");
    ...
    private void runBTN1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_runBTN1ActionPerformed
        // TODO add your handling code here:
        if (sequenceFile1 == null || directory1 == null) {
            JOptionPane.showMessageDialog(this,
                    "Please select the sequence file and the directory for the "
                    + "output to run the program.",
                    "Error",
        ...
        int numberOfRemoved = ds.acceptByRange(sequenceFile1.getPath(), 
                directory1.getPath() + "/", Integer.parseInt(startTF.getText()), Integer.parseInt(endTF.getText()));
